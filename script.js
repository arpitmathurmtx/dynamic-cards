...
<div class="slds-col slds-size_1-of-3">\
    ...
    <div class="slds-col slds-large-size_1-of-1"> '+ data.data.id+ '</div>\
...
<div class="slds-col slds-large-size_1-of-1">\
    ...
    <div class="slds-col slds-large-size_1-of-1 slds-m-bottom_medium"><span class="slds-text-heading_small">'+ data.data.last_name+ '</span></div><div class="slds-col slds-large-size_1-of-1"><span class="slds-text-heading_medium">Email</span></div><div class="slds-col slds-large-size_1-of-1"><span class="slds-text-heading_small">'+ data.data.email +'</span></div><div class="slds-col slds-size_1-of-1 slds-large-size_1-of-1"></div></div><div class="slds-col slds-size_1-of-3"></div></div>'
